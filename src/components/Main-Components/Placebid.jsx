...
function Placebid() {
  return (
   ...
   <div className="Profile">
    ...
    <div className="placebidhead">Place Bid</div>
    ...
    <div className="pbcontainer1"> <div className="pbicon"><AiFillInfoCircle/></div> <div className="pbtext1">Bid Price</div><div className="pbmq" > Max :$200.00</div> 
    <input type="text" placeholder="0" className="pbinput1"/></div>
