...
function SongProfilePresale() {
  return (
    
    <div className="headpageyu">
   <div className="Profile"><div className="profilepresale">PRESALE</div>  
...
<img src={spotify} className="spotify"/> 
    ...
    <Link to="BuyNow">
    <button className="buynowprofilep2">Buy Now</button></Link>
...
export default SongProfilePresale;
