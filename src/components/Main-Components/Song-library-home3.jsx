...
function SongLibraryHome3(props) {
  return (
    <div className="songcard">
      ...
      <Link to="">
        ...
        <Link to="/NewSongProfilePresale" className="sold-card">
        <img className="cardfix" src={props.img} /></Link></div>
        <button className="prebutton">PRESALE</button>
...
export default SongLibraryHome3;
